import { FLOWLU_ENDPOINTS } from './config';
import { makeFlowluRequest } from './request';
import type { FlowluResponse, FlowluContactResponse } from './types';
import type { UserDetails } from '../../../types/checkout';

export async function createContact(
  userDetails: UserDetails
): Promise<FlowluResponse<FlowluContactResponse>> {
  return makeFlowluRequest<FlowluContactResponse>(
