  ...
  const plans = [
    {
      ...
      name: "Basic",
      price: "19.20",
      features: ["1 Account", "2GB Storage", "25Mb Attachment"],
    },
    {
      id: "standard",
      name: "Standard",
      price: "43.20",
      features: ["10 Accounts", "2GB Storage", "25Mb Attachment"],
    },
    {
      id: "business",
      name: "Business",
      price: "69.99",
      features: ["Unlimited Accounts", "2GB Storage", "25Mb Attachment"],
    },
  ];
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      <h2 className="text-2xl font-bold text-center mb-2">
        Choose Email Hosting Plan
      </h2>
      <p className="text-center text-gray-600 text-sm mb-8">
        Email hosting is optional
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        {plans.map((plan) => (
          <div
            ...
            onClick={() =>
              onSelectPlan(
                selectedPlan === plan.id ? null : (plan.id as EmailPlan)
              )
            }
          >
